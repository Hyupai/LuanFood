                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                         ...
                         <br><h6 class="text-muted font-weight-normal">total desde a sua inscrição em <?php echo $inscricao_entregador;?></h6>
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="<?php echo $nome_entregador;?>" readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Endereço de Emaiil:</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="<?php echo $email_entregador;?>"readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Data de Inscricao: </label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="<?php echo $inscricao_entregador;?>"readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Codigo entregador:</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="<?php echo $codigo_entregador;?>"readonly>
                      </div>
