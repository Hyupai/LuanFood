            ...
            <div class=\"profile-desc\">
              <div class=\"profile-pic\">
                ...
                <div class=\"profile-name\">
                  <h5 class=\"mb-0 font-weight-normal\">$nome_entregador</h5>
          ...
          <li class=\"nav-item menu-items\">
            ...
            <div class=\"collapse\" id=\"ui-basic\">
              <ul class=\"nav flex-column sub-menu\">
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"entregas_do_dia.php\">Minhas entregas do dia</a></li>
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"entregas_feitas.php\">Entregas Feitas</a></li>
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"relatorios.php\">Relatorios</a></li>
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"rotas.php\">Rotas</a></li>
              </ul>
            </div>
          </li>
          <li class=\"nav-item menu-items\">
            <a class=\"nav-link\" href=\"entregas_pendentes.php\">
              <span class=\"menu-icon\">
                <i class=\"mdi mdi-clock\"></i>
              </span>
              <span class=\"menu-title\">Entregas Pendentes<br> em Geral</span>
            </a>
          </li>
           <li class=\"nav-item menu-items\">
              ...
              <li class=\"nav-item dropdown\">
                <a class=\"nav-link\" id=\"profileDropdown\" href=\"#\" data-bs-toggle=\"dropdown\">
                  <div class=\"navbar-profile\">
                    <img class=\"img-xs rounded-circle\" src=\"assets/images/faces/face15.jpg\" alt=\"\">
                    <p class=\"mb-0 d-none d-sm-block navbar-profile-name\">$nome_entregador</p>
