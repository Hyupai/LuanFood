      ...
      <?php echo $header;?>
       ...
       // Verifica se os dados foram enviados via POST
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $stmt = $connection->prepare("INSERT INTO entregas (nome_cliente, endereco, status, data, entregador_id) VALUES (?, ?, 3, now(), ?)");
            $stmt->bindParam(1, $dados['nome']);
            $stmt->bindParam(2, $dados['endereco']);
            $stmt->bindParam(3, $dados['entregador']);
            //$stmt->bindParam(4, $data_hoje);
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" class="col-12" autocomplete="off" class="forms-sample">
                      <div class="form-group">
                        ...
                        <input style="color: white !important;" type="text" name="nome" class="form-control" id="exampleInputUsername1">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Endereço:</label>
                        <input style="color: white !important;" type="text" name="endereco" class="form-control" id="exampleInputEmail1">
                      </div>
                      <div class="form-group">
                        ...
                        <option value="0">Não definido</option>
                          <?php
                            ...
                            while($entregador = $stmt->fetch(PDO::FETCH_ASSOC)) {
                              echo "<option value='".$entregador['codigo']."'>".$entregador['nome']."</option>";
                            }
                          ?>
                        </select>
                      </div>
